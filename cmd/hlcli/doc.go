...
var methodCommentMap = map[string]string{
	"NewTokenID": "NewSessionAndTokenID starts a session with the server, and returns the session and token.",
	"SetTokenID": "SetSessionAndTokenID sets the tokenID for the Client.",
